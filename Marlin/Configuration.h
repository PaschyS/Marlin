...
#define STRING_CONFIG_H_AUTHOR "(Renix, CR-10S Pro SKR Pro 1.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10S SKR Pro 1.1"
...
#define TEMP_SENSOR_BED 11 //Bed AC Keenovo
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  71.24, 71.24 }
    #define DEFAULT_Ki_LIST {  12.03, 12.03 }
    #define DEFAULT_Kd_LIST { 105.44, 105.44 }
  #else
  //E3D Hemera v6 80% fang
    #define DEFAULT_Kp  71.24
    #define DEFAULT_Ki  12.03
    #define DEFAULT_Kd 105.44
  #endif
#endif // PIDTEMP
 ...
 * 31x31x0,4=385Watt reduce cycle time to 135
 */
#define MAX_BED_POWER 135 // limits duty cycle to bed; 255=full current
  ...
  //Keenovo 220V EU 750W silicone heater 
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  //#define DEFAULT_bedKp 167.63
  //#define DEFAULT_bedKi 30.09
  //#define DEFAULT_bedKd 233.47

  #define DEFAULT_bedKp 44.67
  #define DEFAULT_bedKi 8.46
  #define DEFAULT_bedKd 157.23
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 250, 10000 } // ...or, set your own edit limits
#endif
 ...
 * disabled if linear advanced enabled
 *
 ...
 */
#define Z_MIN_PROBE_PIN PA2 //SKR Pro BLTouch pin PA2 
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 5, -3.6 }
...
#ifdef I2C_EEPROM
  #define USE_SHARED_EEPROM 1 // Use Plattform-independent Arduino functions for I2C EEPROM
